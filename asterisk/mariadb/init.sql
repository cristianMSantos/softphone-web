...
INSERT INTO `cdr` VALUES ('2025-07-15 20:09:21','\"1001\" <1001>','1001','1001','ramais-teste','PJSIP/1001-00000001','','Hangup','',1,2,'ANSWERED',3,'','1752610161.7','','','1752610161.7',1);
...
INSERT INTO `extensions` VALUES (1,'ramais-teste','1001',1,'Answer',''),(2,'ramais-teste','1001',2,'Playback','hello-world'),(3,'ramais-teste','1001',3,'Hangup','');
...
CREATE TABLE `ps_aors` (
  ...
  `remove_existing` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `support_path` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
INSERT INTO `ps_aors` VALUES ('1001','',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `ps_asterisk_publications` (
  ...
  `device_state` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `device_state_filter` varchar(256) DEFAULT NULL,
  `mailbox_state` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
INSERT INTO `ps_auths` VALUES ('1001','userpass',NULL,NULL,'1001',NULL,'1001',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `ps_endpoint_id_ips` (
  ...
  `srv_lookups` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
CREATE TABLE `ps_endpoints` (
  ...
  `disallow` varchar(200) DEFAULT NULL,
  `allow` varchar(200) DEFAULT NULL,
  `direct_media` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `disable_direct_media_on_nat` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `dtmf_mode` enum('rfc4733','inband','info','auto','auto_info') DEFAULT NULL,
  `external_media_address` varchar(40) DEFAULT NULL,
  `force_rport` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `ice_support` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `outbound_proxy` varchar(255) DEFAULT NULL,
  `rewrite_contact` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `rtp_ipv6` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `rtp_symmetric` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `send_diversion` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `send_pai` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `send_rpid` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `aggregate_mwi` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `trust_id_inbound` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `trust_id_outbound` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `use_ptime` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `use_avpf` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `media_encryption` enum('no','sdes','dtls') DEFAULT NULL,
  `inband_progress` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `fax_detect` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `t38_udptl` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `t38_udptl_ec` enum('none','fec','redundancy') DEFAULT NULL,
  `t38_udptl_maxdatagram` int(11) DEFAULT NULL,
  `t38_udptl_nat` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `t38_udptl_ipv6` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `tone_zone` varchar(40) DEFAULT NULL,
  `language` varchar(40) DEFAULT NULL,
  `one_touch_recording` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `record_on_feature` varchar(40) DEFAULT NULL,
  `record_off_feature` varchar(40) DEFAULT NULL,
  `rtp_engine` varchar(40) DEFAULT NULL,
  `allow_transfer` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `allow_subscribe` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `srtp_tag_32` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `force_avp` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `media_use_received_transport` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `accountcode` varchar(80) DEFAULT NULL,
  `user_eq_phone` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `moh_passthrough` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `media_encryption_optimistic` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `rpid_immediate` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `g726_non_standard` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `rtp_keepalive` int(11) DEFAULT NULL,
  `rtp_timeout` int(11) DEFAULT NULL,
  `rtp_timeout_hold` int(11) DEFAULT NULL,
  `bind_rtp_to_media_address` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `voicemail_extension` varchar(40) DEFAULT NULL,
  ...
  `preferred_codec_only` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `asymmetric_rtp_codec` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `rtcp_mux` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `allow_overlap` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `refer_blind_progress` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `notify_early_inuse_ringing` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `max_audio_streams` int(11) DEFAULT NULL,
  `max_video_streams` int(11) DEFAULT NULL,
  `webrtc` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `dtls_fingerprint` enum('SHA-1','SHA-256') DEFAULT NULL,
  `incoming_mwi_mailbox` varchar(40) DEFAULT NULL,
  `bundle` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `dtls_auto_generate_cert` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `follow_early_media_fork` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `accept_multiple_sdp_answers` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `suppress_q850_reason_headers` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `suppress_moh_on_sendonly` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  UNIQUE KEY `id` (`id`),
...
INSERT INTO `ps_endpoints` VALUES ('1001','transport-udp','1001','1001','ramais-teste','all','ulaw,alaw,gsm','no',NULL,NULL,NULL,NULL,'rfc4733',NULL,'yes',NULL,NULL,NULL,NULL,NULL,NULL,'yes',NULL,'yes',NULL,NULL,NULL,NULL,NULL,NULL,'1001 <1001>',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `ps_globals` (
  ...
  `disable_multi_domain` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `mwi_disable_initial_unsolicited` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `ignore_uri_user_options` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
CREATE TABLE `ps_outbound_publishes` (
  ...
  `transport` varchar(40) DEFAULT NULL,
  `multi_user` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
CREATE TABLE `ps_registrations` (
  `id` varchar(255) NOT NULL,
  `auth_rejection_permanent` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `line` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `endpoint` varchar(255) DEFAULT NULL,
...
CREATE TABLE `ps_resource_list` (
  ...
  `event` varchar(40) DEFAULT NULL,
  `full_state` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
CREATE TABLE `ps_systems` (
  ...
  `compact_headers` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  ...
  `disable_tcp_switch` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `follow_early_media_fork` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `accept_multiple_sdp_answers` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
CREATE TABLE `ps_transports` (
  ...
  `method` enum('default','unspecified','tlsv1','tlsv1_1','tlsv1_2','tlsv1_3','sslv2','sslv23','sslv3') DEFAULT NULL,
  ...
  `require_client_cert` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `verify_client` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `verify_server` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `tos` varchar(10) DEFAULT NULL,
  `cos` int(11) DEFAULT NULL,
  `allow_reload` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `symmetric_transport` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  `allow_wildcard_certs` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
...
INSERT INTO `ps_transports` VALUES ('transport-udp',NULL,'0.0.0.0:5060',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'udp',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `queues` (
  ...
  `log_restricted_caller_id` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `stir_tn` (
  ...
  `send_mky` enum('0','1','off','on','false','true','no','yes') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stir_tn`
--

LOCK TABLES `stir_tn` WRITE;
/*!40000 ALTER TABLE `stir_tn` DISABLE KEYS */;
/*!40000 ALTER TABLE `stir_tn` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-07-19 13:33:04
